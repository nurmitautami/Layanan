 ...
 <header class="masthead">
 	<div class="container">
 		...
 		<div class="masthead-heading text-uppercase">Kelurahan Air Hitam</div>
 ...
 <section class="page-section" id="profil">
 	<div class="container">
 		<div class="text-center">
 			...
 			<h3 class="section-subheading text-muted">Kelurahan Air Hitam, Kecamatan Bangkinang, Kabupaten Kampar</h3>
 		</div>
 			...
 			<div class="col-lg-4 col-sm-6 mb-4">
 				<div class="portfolio-item">
 					...
 					<div class="portfolio-caption">
 						<div class="portfolio-caption-heading">Sruktur Kelurahan Air Hitam</div>
	...
	<div class="container">
		...
		<div class="row text-justify pl-5 pr-5">
 			<p>Diberitahukan untuk melakukan Pengajuan Surat Online dimohon untuk melengkapi data dengan benar dan 
				 ...
				 form Pengajuan Surat Online dimohon kepada pengaju untuk datang langsung ke Kantor Kelurahan Air Hitam, 
